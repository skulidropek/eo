...
```text
classes.xsl              40253  33.89%
to-java.xsl              36084  30.38%
set-locators.xsl         12198  10.27%
set-original-names.xsl   7388   6.22%
attrs.xsl                5333   4.49%
data.xsl                 4664   3.93%
tests.xsl                4381   3.69%
anonymous-to-nested.xsl  4325   3.64%
package.xsl              4144   3.49%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-06-15 at 14:26,
on Linux with 4 CPUs.
The total is 118770 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/27553014409
